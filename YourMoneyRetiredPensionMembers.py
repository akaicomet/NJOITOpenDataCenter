def RetiredPensionMembersDataWrangler(_data):
    ...
    RetiredPension_df_grped = RetiredPension_df[['report_year_month','member_frst_name','member_middle_initial','member_last_name','member_birth_year','member_last_employer','member_pension_fund','member_retirement_date','retirement_cancellation_date','ytd_total_paymnts','member_salary_for_calculation']]
